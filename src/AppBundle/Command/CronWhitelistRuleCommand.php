...
class CronWhitelistRuleCommand extends ContainerAwareCommand{

    protected function configure()
    {
        $this
            // the name of the command (the part after "bin/console")
            ->setName('cron:whitelist-rule')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach($campaignGroups as $key) {
            ...
            if ($key['active'] == 1) {
                ...
                $ruleConditions = $this->getCampaignConditionsById($em, $key['campaignRulesId']);
    ...
    public function getCampaignConditionsById($em, $id)
    {
    ...
    public function insertBotReport($em, $campaignRulesId, $tid, $cid, $type, $placement, $visits, $clicks, $ctr, $conversions, $revenue, $cost, $profit, $cpv, $epv, $roi, $dateExecuted, $status){
    ...
    public function updateBotReport($em, $cid, $placement, $visits, $clicks, $ctr, $conversions, $revenue, $cost, $profit, $cpv, $epv, $roi, $dateExecuted){
    ...
    public function insertBannedPlacement($em, $placement, $visits, $cost, $conversions, $ctr, $roi){
    ...
    public function getSafeListPlacement($em, $cid){
