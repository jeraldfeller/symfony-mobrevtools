...
class CronBlacklistRuleCommand extends ContainerAwareCommand{

    protected function configure()
    {
        $this
            // the name of the command (the part after "bin/console")
            ->setName('cron:blacklist-rule')
    ...
    public function getCampaignConditionsById($id, $em)
    {
