...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.cake_api' => 'getApp_CakeApiService',
            'app.campaign_controller' => 'getApp_CampaignControllerService',
            'app.common_controller' => 'getApp_CommonControllerService',
            'app.datatable.users' => 'getApp_Datatable_UsersService',
            'app.exoclick_api' => 'getApp_ExoclickApiService',
            'app.settings' => 'getApp_SettingsService',
            'app.system_controller' => 'getApp_SystemControllerService',
            'app.voluum_api_controller' => 'getApp_VoluumApiControllerService',
            'app.zeropark_api_controller' => 'getApp_ZeroparkApiControllerService',
    ...
    /**
     * Gets the 'app.cake_api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\CakeApiController A AppBundle\Controller\CakeApiController instance
     */
    protected function getApp_CakeApiService()
    {
        return $this->services['app.cake_api'] = new \AppBundle\Controller\CakeApiController();
    }

    /**
     * Gets the 'app.campaign_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\CampaignController A AppBundle\Controller\CampaignController instance
     */
    protected function getApp_CampaignControllerService()
    {
        return $this->services['app.campaign_controller'] = new \AppBundle\Controller\CampaignController();
    }

    /**
     * Gets the 'app.common_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\CommonController A AppBundle\Controller\CommonController instance
     */
    protected function getApp_CommonControllerService()
    {
        return $this->services['app.common_controller'] = new \AppBundle\Controller\CommonController();
    }

    /**
     * Gets the 'app.datatable.users' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Datatables\UsersEntityDatatable A AppBundle\Datatables\UsersEntityDatatable instance
     */
    protected function getApp_Datatable_UsersService()
    {
        return $this->services['app.datatable.users'] = new \AppBundle\Datatables\UsersEntityDatatable($this->get('security.authorization_checker'), $this->get('security.token_storage'), $this->get('translator.default'), $this->get('router'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.exoclick_api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\ExoClickApiController A AppBundle\Controller\ExoClickApiController instance
     */
    protected function getApp_ExoclickApiService()
    {
        return $this->services['app.exoclick_api'] = new \AppBundle\Controller\ExoClickApiController();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\SettingsController A AppBundle\Controller\SettingsController instance
     */
    protected function getApp_SettingsService()
    {
        return $this->services['app.settings'] = new \AppBundle\Controller\SettingsController();
    }

    /**
     * Gets the 'app.system_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\SystemController A AppBundle\Controller\SystemController instance
     */
    protected function getApp_SystemControllerService()
    {
        return $this->services['app.system_controller'] = new \AppBundle\Controller\SystemController();
    }

    /**
     * Gets the 'app.voluum_api_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\VoluumApiController A AppBundle\Controller\VoluumApiController instance
     */
    protected function getApp_VoluumApiControllerService()
    {
        return $this->services['app.voluum_api_controller'] = new \AppBundle\Controller\VoluumApiController();
    }

    /**
     * Gets the 'app.zeropark_api_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\ZeroparkApiController A AppBundle\Controller\ZeroparkApiController instance
     */
    protected function getApp_ZeroparkApiControllerService()
    {
        return $this->services['app.zeropark_api_controller'] = new \AppBundle\Controller\ZeroparkApiController();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Z9C9vv0oAA', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SJDP7A08ib', 0, 'WpkMWyIK+2y9Heo5siF-1K', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'mobrevto_db', 'user' => 'mobrevto_dash', 'password' => 'NK_L6ovprZA1', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8e3762f5207d8bba6697ef7e13248087b4bf6c40ca3ff0249337a1929a9869fa');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('VDG5Cc6RxL', NULL, 'WpkMWyIK+2y9Heo5siF-1K', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PoYZOWSd7d', 0, 'WpkMWyIK+2y9Heo5siF-1K', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('595a9b370e5a31.81055075')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'mobrevto_db',
            'database_user' => 'mobrevto_dash',
            'database_password' => 'NK_L6ovprZA1',
